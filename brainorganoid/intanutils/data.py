...
from brainorganoid.intanutils.report import print_record_time_summary, print_progress
...
def calculate_data_size(header, filename, fid):
    ...
    recorded_time = print_record_time_summary(num_samples,
                              header['sample_rate'],
                              data_present)

    return data_present, filesize, num_blocks, num_samples, recorded_time
